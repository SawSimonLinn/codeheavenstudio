...
/**
 * Renders the site's homepage, composing header, hero, a continuous scrolling marquee, content sections (FreeDemo, PreviousProjects, Process, WhyUs, Testimonials), a final call-to-action with decorative gradient orbs and a gradient CTA button linking to contact, and the footer.
 *
