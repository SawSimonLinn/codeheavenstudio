...
export const metadata: Metadata = {
  title: "Mia Truong – Co-Founder of Code Heaven Studio",
  description:
    "Mia Truong is the Co-Founder of Code Heaven Studio, focusing on business development, partnerships, and client success for restaurants and small businesses in San Diego, California.",
  alternates: {
        ...
        <section className="py-16 sm:py-24">
          <div className="container mx-auto max-w-4xl px-4">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-4">
              <p>
                Mia Truong co-founded Code Heaven Studio and focuses on business development,
                partnerships, and client success. She is dedicated to making sure every client
                gets the attention, guidance, and results they deserve, from the first conversation
                to the final website launch.
              </p>
              <p>
        ...
        <section className="bg-muted/40 py-16 sm:py-24">
          <div className="container mx-auto max-w-4xl px-4">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {["Co-Founder", "Business Development", "Client Success", "Partnerships", "Strategy", "Project Management"].map((tag) => (
                <Badge key={tag} variant="secondary">{tag}</Badge>
              ))}
            </div>
            <p className="text-muted-foreground leading-relaxed">
              As Co-Founder, Mia Truong leads business development, client relations, and partnership
              strategy at Code Heaven Studio. She works directly with restaurant owners and small
              business clients to understand their goals, communicate the vision to the development
              team, and ensure every project is delivered with care and quality.
            </p>
          </div>
        </section>
