...
/**
 * Render the Projects page with a hero, category filter, project cards, stats strip, and footer.
 *
 * Renders a header, a large hero banner showing total projects, a sticky horizontally scrollable
 * category pill filter that updates the visible projects, a list of ProjectCard components
 * (with every third card rendered in a wider layout), a statistics strip, and a footer.
 *
 * @returns The Projects page element that handles category state and displays filtered projects.
 */
...
/**
 * Renders an interactive project card populated from a project record.
 *
 * The card displays the project's image, category, timeline, title, short description,
 * a subset of tech stack chips, and CTAs for viewing the project or opening the live site.
 * It is focusable and activates navigation to the project's detail page when clicked or
 * activated via keyboard (Enter).
 *
 * @param project - The project data used to populate the card (image, title, category, timeline, techStack, liveUrl, shortDescription, slug, etc.).
 * @param index - Zero-based index of the project used to generate the two-digit watermark number.
 * @param wide - When true, renders larger typography and a wider visual layout for the card.
 * @returns A clickable project card element that navigates to the project's detail route.
 */
