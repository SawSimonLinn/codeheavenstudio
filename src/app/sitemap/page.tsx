...
const sitemapSections = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "AI Applied Websites", href: "/services/ai-applied-websites" },
      ...
      { label: "Wix to Custom Website", href: "/services/wix-to-custom" },
      { label: "Website Redesign", href: "/services/website-redesign" },
      { label: "SEO & AI Search Optimization", href: "/services/seo-optimization" },
