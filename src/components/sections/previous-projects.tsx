...
const projects = [
  ...
  },
  {
    ...
    description: 'A modern and sleek website for a tech startup.',
    imageUrl: 'https://placehold.co/600x400.png',
    aiHint: 'corporate website',
  },
  {
    title: 'Booking System',
    description: 'An integrated booking system for a travel agency.',
    imageUrl: 'https://placehold.co/600x400.png',
    aiHint: 'booking app',
  },
];
...
export default function PreviousProjectsSection() {
  return (
    <section id="previous-work" className="container mx-auto px-4 py-16 sm:py-24">
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl font-headline">
          Explore Our Previous Work
        </h2>
        <p className="mt-4 text-lg leading-8 text-muted-foreground">
          We take pride in the solutions we've delivered. Here are a few examples of our work.
        </p>
      </div>
