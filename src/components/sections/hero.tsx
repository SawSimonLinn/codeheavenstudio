...
/**
 * Renders the hero section with a full-bleed video background, left-aligned content (badge, multi-line heading with a highlighted span, description, CTAs, and stats), and a right-side browser mockup with a floating testimonial card and badge on large screens.
 *
