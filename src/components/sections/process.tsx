...
/**
 * Render the "How We Work" process section that presents four numbered steps.
 *
 * The section contains a heading ("Four steps. Zero guesswork.") and a responsive
 * 1/2/4-column grid of step cards; each card shows a large step number, an icon,
 * a title, and a short description.
 *
 * @returns A React element representing the process section with four step cards.
 */
