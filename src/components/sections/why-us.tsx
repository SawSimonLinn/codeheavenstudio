...
/**
 * Renders the "Why Choose Us" section containing a sticky introductory panel with heading, supporting copy and a call-to-action, alongside a vertically divided list of benefit items.
 *
 * @returns A JSX element for the section with id "why-us" that includes the intro/CTA panel and the mapped benefits list.
 */
